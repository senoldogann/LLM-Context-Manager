...
> **Current release: v0.3.2.** Adds the self-improving retrieval policy layer
> (Phase 1: proof of mechanism) on top of v0.3.1's vector deletion, strict MCP
> allowlist, and incremental manifest fixes.
